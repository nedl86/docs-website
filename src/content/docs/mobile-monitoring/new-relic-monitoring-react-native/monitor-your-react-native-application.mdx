...
To install the React Native agent, follow our [guided install](https://onenr.io/01wZvXb8Bw6), located directly in the UI. You can also view the installation steps via the [GitHub repository](https://github.com/newrelic/newrelic-react-native-agent).
